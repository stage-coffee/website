 ...
 * @private
 */
export declare const createPlainClient: (makeRequest: MakeRequest, defaults: DefaultParams | undefined, alphaFeatures?: string[]) => PlainClientAPI | AlphaPlainClientAPI;
